      ...
      <div className="mx-auto flex max-w-3xl flex-col">
        ...
        <form onSubmit={handleSubmit} className="mt-14 w-full">
          <div className="flex flex-col">
            {fields.map((field) => (
              <label
                key={field.name}
                className=" block border-b border-white/18  py-4 sm:py-5 focus-within:border-white duration-200"
              >
          ...
          <button
            ...
            className="mt-10 inline-flex items-center justify-center rounded-full bg-[#f5f5f4] px-8 py-4 text-sm font-semibold text-[#0b0b0c] transition-colors hover:bg-white disabled:opacity-70"
          >
        ...
        <div className="mt-24 flex flex-col gap-2 text-base text-[#f5f5f4]/90 sm:text-lg">
          ...
          <p>
            ...
            <a href="tel:+201090324648" className="hover:text-orange-700">
              +2010- 9032- 4648
            </a>
          </p>
        </div>
        ...
        <div className="mt-10 flex flex-wrap items-center gap-x-8 gap-y-4">
          {socials.map(({ label, href, icon }) => (
            ...
            >
              <span className="flex h-7 w-7 items-center justify-center rounded-md border border-white/[0.18]">
                <svg
                  viewBox="0 0 24 24"
                  width="15"
                  height="15"
