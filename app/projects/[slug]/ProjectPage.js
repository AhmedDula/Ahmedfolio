      ...
      >
        ...
        return  (
            <div key={i} className="flex flex-col gap-3">
              <Link href={`/projects/${mp.slug}`} className="w-full h-[90%] border border-white/20 rounded-2xl overflow-hidden">
                <Image
                  src={mp.coverImage}
                  width={1920}
                  height={1080}
              ...
              <div className="w-full h-[20%] border border-white/20 rounded-2xl px-5 py-10 sm:py-2 flex flex-col justify-center">
                <p className="text-body sm:text-title font-bold">{mp.title}</p>
