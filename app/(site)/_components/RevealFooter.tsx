...
export default function RevealFooter() {
  ...
  return (
    ...
    >
      ...
      <div
        id="footer-content"
        className="w-full flex justify-between text-lead py-20 sm:py-6 px-4 sm:px-8 items-end mix-blend-difference z-10"
      >
        {" "}
        ...
        <div className="sm:text-title font-bold">
          {" "}
          <p className=" ">
            {"// Creative Developer"}
          </p>{" "}
          <p className="  pl-4 sm:pl-12">
            {" "}
            Art Designer{" "}
          </p>{" "}
        </div>{" "}
