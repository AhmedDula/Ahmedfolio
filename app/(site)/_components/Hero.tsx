 ...
 useGSAP(() => {
  ...
  return (
    ...
    >
      ...
      <div
        id="hero-footer"
        className="w-full flex justify-between py-27 sm:py-5 px-4 sm:px-8 items-end z-10 text-white mix-blend-difference"
      >
        <div id="links" className="flex flex-col justify-between text-lead">
          <Link
            href={"https://www.linkedin.com/in/ahmed-adel-said/"} target="_blank"
            data-title="Linkedin"
          ...
          <Link
            href={"https://github.com/AhmedDula"} target="_blank"
            data-title="GitHub"
            className="link hover:text-cyan-700"
          >
            GitHub
          ...
          <Link
            href={"https://www.instagram.com/jr.ahmd/"} target="_blank"
        ...
        <div className="text-lead sm:text-heading">
          <p className="font-semibold ">{"// Creative Developer"}</p>
      ...
      <Image
        ...
        quality={75}
        preload
        alt="Ahmed Portfolio, Creative Developer"
      />
    </section>
  );
}
