      ...
      >
        {digits.map((digit) => (
          <span
            key={digit}
            className="block"
            style={{ height: "1em", lineHeight: "1em" ,fontFamily:"monospace"}}
  ...
  return (
    ...
    >
      ...
      >
        <span
          id="service-span"
          className="text-orange-700 sticky top-0 text-lead h-fit z-91 whitespace-nowrap"
        >
          {"// service"}
        </span>
          ...
          {SERVICES.map((service, i) => (
            ...
            >
              <div className="flex flex-col">
                <h2 className="text-heading font-bold">{service.title}</h2>
                <p className="sm:w-2/3 text-body  sm:px-3 opacity-55">
                  {service.description}
                </p>
              </div>
              <div className="flex flex-col">
                {service.items.map((item, j) => (
                  ...
                  >
                    <h3 className="text-lead">{item}</h3>
                    <span className="font-mono">{String(j + 1).padStart(2, "0")}</span>
                  </div>
                ))}
              </div>
            </div>
