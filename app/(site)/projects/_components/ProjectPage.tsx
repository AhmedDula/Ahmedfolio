  ...
  return (
    <main className=" bg-background relative z-2">
      <section
        ...
        className="f min-h-screen w-screen"
      >
        ...
        <div className="e w-screen h-screen flex sm:flex-row flex-col sm:gap-3">
          ...
          <div className="w-full h-full text-title leading-none px-6  flex flex-col gap-6">
            <div>
              <h2 className="text-orange-600 text-lead font-mono">
                {"// Overview"}
              </h2>
            ...
            <Link
              href={project.link}
              target="_blank"
              className="w-full border border-white/18 p-3 text-center bg-orange-700 hover:bg-orange-600 duration-300 relative rounded-es-3xl text-lead"
            >
              Go {project.title}{" "}
              <FiArrowUpRight className="absolute top-0 right-0 " />
            </Link>
          </div>
        </div>
      </section>
        ...
        <div className="w-full min-h-screen h-fit grid grid-cols-1 xl:grid-cols-3 gap-6">
          {projects.map((mp, i) => {
            ...
            return (
              <article
                key={i}
                className="flex flex-col  md:flex-row xl:flex-col gap-3 w-full"
              >
                <Link
      ...
      <section className=" h-fit relative w-screen ">
        <h2 className=" text-orange-700 font-semibold mix-blend-difference sticky top-0 w-fit h-fit z-9001 px-4 sm:px-8 py-5">
          {"// Live Preview"}
        </h2>
        <div className="mt-40 ">
          {projects.map((p, i) => (
    ...
    "
                ...
                <div className="flex gap-1 w-full flex-col sm:flex-row justify-between  ">
                  ...
                  <p className="w-full whitespace-nowrap flex sm:justify-center">
                    {p.category}
                  </p>
                </div>
